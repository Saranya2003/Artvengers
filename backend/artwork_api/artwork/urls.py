...
urlpatterns = [
    ...
    path('add_artwork_mobile/', views.insertartwork, name="add_artwork_mobile"),
    path('update_artwork_mobile/<int:pk>', views.updateartworkpost, name="update_artwork_mobile"),
    path('add_album_mobile/', views.insertalbum, name="add_album_mobile"),
