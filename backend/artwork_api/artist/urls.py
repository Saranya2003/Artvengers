...
from .views import create_profile_action, UserRegisterView,ChangePasswordsView,UpdateProfileView,ShowProfileView,updateprofile,CreateProfileView,change_password
urlpatterns = [
    ...
    path('changeprofileaction/', change_password,name='change_password_action'),
